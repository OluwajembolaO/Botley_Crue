...
@Autonomous(name = "PP - Path 2 (RedUP)", group = "Competition")
public class PP_2 extends OpMode {
    ...
    // PATH 1 POSES
    private final Pose startPose = new Pose(144-23.10763209393346, 119.48336594911936, Math.toRadians(180-135));
    private final Pose shootPose = new Pose(144-35.788649706457925, 107.36594911937378, Math.toRadians(180-135));
    private final Pose parkPose = new Pose(144-71.57729941291585, 132.44618395303328, Math.toRadians(270));
    ...
    public void init() {
        ...
        telemetry.addLine("Path 1 (Original) - Ready to start");
        telemetry.update();
    }
    ...
    public void loop() {
        ...
        telemetry.addData("Path", "1 (Original)");
